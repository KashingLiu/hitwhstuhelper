                        ...
                        <div style="text-align: center; margin: 100px">
                            ...
                            <form action="./index.php" name="frm" method="post">
                                <select name="s1" onChange="redirec(document.frm.s1.options.selectedIndex)">
                                    ...
                                    <option value="M">M楼</option>
                                    <option value="N">N楼</option>
                                ...
                                {
                                    echo "<a href=\"./change.html\"><input type=\"button\" value=\"修改\"></a>";
                                }
                            ...
                            <script language="javascript">
                                ...
                                select2[1][1] = new Option("2层", "2");

                                select2[2][0] = new Option("1层", "1");
                                select2[2][1] = new Option("2层", "2");
                                select2[2][2] = new Option("3层", "3");
                                ...
                                select2[4][0] = new Option("3层", "3");
                                select2[4][1] = new Option("4层", "4");
                                select2[4][2] = new Option("5层", "5");
                                //联动函数
                                function redirec(x)
                                {
