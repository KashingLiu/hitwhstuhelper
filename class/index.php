            ...
            <div class="wrap">
                <nav id="site-navigation" class="main-navigation" role="navigation" aria-label="顶部菜单">
                    ...
                    <div class="menu-%e9%a1%b6%e9%83%a8%e8%8f%9c%e5%8d%95-container"><ul id="top-menu" class="menu"><li id="menu-item-20" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-home menu-item-20"><a href=".././usrmain.php">首页</a></li>
                            ...
                            <li id="menu-item-31" class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-39 current_page_item menu-item-31"><a href=".././class/index.php">课程查询</a></li>
                    ...
                    <article id="post-7" class="twentyseventeen-panel  post-7 page type-page status-publish hentry" >
                        ...
                        <div style="text-align: center; margin: 100px">
                            ...
                            <td style=\"padding:8px 6px;\">第三大节</td>";
                                ...
                                echo "<td style=\"padding:8px 6px;\"><button class=\"button button-primary button-rounded button-small\"><a href='./1330.php'>提醒</a></button></td>";
                                echo "<td style=\"padding:8px 6px;\"><button class=\"button button-primary button-rounded button-small\"><a href='./cancel1330.php'>取消</a></button></td>";
                                echo "</tr>";
                            ...
                            <td style=\"padding:8px 6px;\">第四大节</td>";
                                ...
                                echo "<td style=\"padding:8px 6px;\"><button class=\"button button-primary button-rounded button-small\"><a href='./1550.php'>提醒</a></button></td>";
                                echo "<td style=\"padding:8px 6px;\"><button class=\"button button-primary button-rounded button-small\"><a href='./cancel1550.php'>取消</a></button></td>";
                                echo "</tr>";
