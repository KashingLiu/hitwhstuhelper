<?php
//设定用户提醒功能  13：30场  记录在c.sh中  需要email的session
session_start();
$myfile = fopen("/data/wwwroot/www.kashingliu.xyz/c.sh", "w") or die("Unable to open file!");
...
fwrite($myfile,$txt);
fclose($myfile);
echo "已设定提醒，将在每天早上13：30发送到您的邮箱：".$_SESSION['email']."现在将跳转";
$url = "./index.php";
